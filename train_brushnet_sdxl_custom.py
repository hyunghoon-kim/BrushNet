...
def main(args):
    ...
    train_dataset = load_dataset("webdataset", 
                    ...
                    split="train", 
                    streaming=True)
    # train_dataset_len= 10000*len(os.listdir(args.train_data_dir)) # 😀 convert real sampels cnt
    train_dataset_len= 8 # 😀 convert real sampels cnt 8
